...
def generate(
    ...
    >>> generate(2, 3, 1, 2, r, 0.1)
     [(0.5, 2.8, 0, False, 0, True), (0.7000000000000001, 2.5, 1, False, 0,
     True), (0.6000000000000001, 1.2, 2, True, 0, True), (0.1,
         1.7000000000000002, 3, True, 0, True), (0.2, 1.3, 4, True, 0, True)]
    """
